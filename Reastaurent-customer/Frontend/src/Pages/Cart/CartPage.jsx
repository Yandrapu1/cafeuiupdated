  ...
  return (
    <div className="w-full min-h-screen pt-32 pb-24 bg-[#110e0d]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mb-12">
          <h1 className="font-serif text-4xl font-bold text-white md:text-5xl">Your Cart</h1>
          ...
          <div className="grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-7 space-y-6">
              {cart.map((item) => {
                ...
                return (
                  <div key={item.cart_key || item.id} className="flex gap-6 p-6 rounded-3xl border border-white/10 bg-white/5 items-center">
                    ...
                    <div className="flex items-center rounded-full border border-cafe-gold/30 bg-[#1c1917]">
                      ...
                      <button onClick={() => onAdd(item)} className="p-3 text-cafe-gold hover:bg-white/5 rounded-r-full">
