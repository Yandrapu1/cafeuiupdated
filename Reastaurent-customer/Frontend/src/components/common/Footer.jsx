          ...
          <div className="flex flex-col p-2 transition-colors ">
            ...
            <div className="flex gap-4 mt-auto">
              {[
                ...
                <a key={i} href="#" className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/[0.02] text-white transition-all hover:-translate-y-2 hover:shadow-[0_0_25px_rgba(212,175,55,0.4)] hover:border-cafe-gold hover:bg-cafe-gold hover:text-[#110e0d]">
