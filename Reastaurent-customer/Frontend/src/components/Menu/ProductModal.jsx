...
export default function ProductModal({ item, addons, loading, onClose, onConfirm }) {
        ...
        <div className="flex flex-1 flex-col w-full md:w-1/2 h-[50vh] md:h-full">
          ...
          <div className="flex-1 overflow-y-auto px-8 py-6 custom-scrollbar">
            <div className="hidden md:block mb-8">
              ...
              <p className="text-white/70 font-sans text-lg leading-relaxed">
                {item.item_description || "A delicious addition to your meal."}
              </p>
            </div>
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition-colors ${
                                  isSelected ? "border-cafe-gold bg-cafe-gold" : "border-white/20"
                                }`}>
                                  {isSelected && <Check className="w-3.5 h-3.5 text-[#110e0d]" />}
                                </div>
                                <span className={`font-sans ${isSelected ? "text-white font-bold" : "text-white/80"}`}>
                                  {addon.addon_name}
                                </span>
                              </div>
          ...
          <div className="border-t border-white/5 bg-[#1a1715] px-8 py-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-cafe-gold text-[#110e0d] font-bold text-lg py-4 rounded-xl hover:bg-white transition-colors shadow-lg shadow-cafe-gold/20"
            >
